  ...
  if (success) {
    return (
      <div className="bg-[#F5F7FA] dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen font-display antialiased flex flex-col items-center justify-center p-4">
        <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-8 shadow-sm text-center">
          ...
          <Link
            to="/signin"
            className="inline-block bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white font-bold py-3 px-6 rounded-xl hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors"
          >
            Go to Sign In
          </Link>
        </div>
    ...
    <div className="bg-[#F5F7FA] dark:bg-background-dark text-slate-900 dark:text-slate-100 min-h-screen font-display antialiased flex flex-col items-center justify-center p-4">
      ...
      <div className="w-full max-w-md bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-3xl p-8 shadow-sm relative">
        ...
        <div className="text-center mb-10 pt-4">
          <h1 className="text-3xl font-black tracking-tight uppercase mt-2">Create Account</h1>
          <p className="text-sm font-bold text-slate-500 mt-2">Join Pingo to save your sheets</p>
        </div>

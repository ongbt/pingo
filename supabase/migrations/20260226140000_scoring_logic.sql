-- Adds tiered scoring logic for Bingos

ALTER TABLE public.player
  ADD COLUMN IF NOT EXISTS bingo_rank INTEGER;
...
BEGIN
  ...
  -- Lock the game row to serialize concurrent claims
  PERFORM 1 FROM public.game WHERE id = p_game_id FOR UPDATE;

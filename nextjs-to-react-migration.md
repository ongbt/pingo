...
Replace Next.js with Vite + React + react-router-dom, keeping all pages and
logic intact.
...
- [ ] Task 9: Verify → Run `npm run dev`, test all routes

## Done When

- [ ] `npm run dev` starts with no errors
- [ ] All 6 routes work: `/`, `/create`, `/join`, `/lobby/:id`, `/game/:id`,
      `/sheets`
